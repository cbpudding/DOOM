...
void I_InitGraphics(void) {
  ...
  if (!XMatchVisualInfo(X_display, X_screen, 24, TrueColor, &X_visualinfo))
    I_Error("This version of xdoom currently only supports 24-bit TrueColor "
            "screens");
  ...
  {*/
  image = XCreateImage(X_display, X_visual, 24, ZPixmap, 0, (char *)imagebuff,
                       X_width, X_height, 8, 0);
